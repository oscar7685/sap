            ...
            <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="home">
                                    ...
                                    <tbody>
                                        <c:forEach items="${actividades}" var="item" varStatus="iter">
                                            <tr>
                                                ...
                                                <td>   
                                                    <a href="#editarMeta&${item.idactividad}" title="Editar"><i class="icon-edit"></i></a>
                                                 </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                        ...
                        <a href="#crearActividad" class="btn btn-large btn-primary"><i class="icon-plus"></i> Crear Actividad</a>    
                    </div>
