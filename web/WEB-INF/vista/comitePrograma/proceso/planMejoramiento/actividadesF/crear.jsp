    ...
    $(document).ready(function() {
        ...
        $("#formCrearActividad").validate({
            ...
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: "/sap/controladorCP?action=crearActividadF2",
...
<ul class="breadcrumb">
    ...
    <li><a href="<%=request.getContextPath()%>/#editarFortaleza&${hallazgo.idhallazgo}" class="tool" data-placement="top" rel="tooltip" data-original-title="${hallazgo.hallazgo}">Fortaleza</a> <span class="divider">/</span></li>
    <li><a href="<%=request.getContextPath()%>/#verActividadesF&${hallazgo.idhallazgo}" class="tool" data-placement="top" rel="tooltip" data-original-title="Listar Actividades">Actividades</a> <span class="divider">/</span></li>
    <li>Crear</li>
