    ...
    $(function() {
        $("#formEditPonderarCara").validate({
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: "/sapenfermeria/controladorCP?action=editPonderarCara",
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${listPonderacionCara}" var="row" varStatus="iter">
                                    ...
                                    <tr id="PonderacionCaracteristica${iter.index+1}">    
                                        ...
                                        <td>
                                            <textarea value="" name="justificacion${row.id}" rows="4" class="span5 {required:true}" maxlength="1999">${row.justificacion}</textarea>
                                        </td>
                                    </tr>
