...
@NamedQueries({
    ...
    @NamedQuery(name = "Respuestas.findByPreguntaRolxPrograma", query = "SELECT r FROM Respuestas r JOIN r.participanteIdparticipante p JOIN p.participanteHasRolList rl WHERE r.preguntaId = :idPregunta and rl.rolId =:idRol and rl.programaId =:idPrograma"),
