    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action != null) {
            ...
            if (tp != null && tp.equals("Fuente")) {
                ...
                } else if (usuario != null && usuario.size() > 1) {
                    out.print(2);
            ...
            } else if (tp != null && tp.equals("Comite central")) {
                ...
                out.print(4);
                System.out.println("Intentando entrar sin tipo de usuario");
            }
