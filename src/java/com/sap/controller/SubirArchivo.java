                                ...
                                for (int i = 0; i < ficheros.length; i++) {
                                    ...
                                    if (!aux.equals("")) {
                                        if (elementos[1].equals("pdf")) {
                                            aux += ",{\"name\":\"" + ficheros[i] + "\",\"size\":\"" + 2000 + "\",\"url\":\"/sap/file/" + ficheros[i] + "\",\"thumbnailUrl\":\"/docenciaservicio/thumbnails/" + "pdf2.png" + "\",\"deleteUrl\":\"/docenciaservicio/Subir?file=" + ficheros[i] + "\",\"deleteType\":\"DELETE\",\"type\":\"" + elementos[1] + "\"}";
                                        } else {
                                            aux += ",{\"name\":\"" + ficheros[i] + "\",\"size\":\"" + 2000 + "\",\"url\":\"/sap/file/" + ficheros[i] + "\",\"thumbnailUrl\":\"/docenciaservicio/thumbnails/" + ficheros[i] + "\",\"deleteUrl\":\"/docenciaservicio/Subir?file=" + ficheros[i] + "\",\"deleteType\":\"DELETE\",\"type\":\"" + elementos[1] + "\"}";
                                        }
