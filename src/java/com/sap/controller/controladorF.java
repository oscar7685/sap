        ...
        try {
            if (action.equals("indexF")) {
                ...
                if (action.equals("responderEncuestaF")) {
                    ...
                    System.out.println("proceso: " + p.getModeloId().getId());
                    if (p.getModeloId().getId() == 4) {
                                ...
                                try {
                                    for (Pregunta pregunta : preguntas) {
                                        ...
                                        if (pregunta.getTipo().equals("1")) {
                                            ...
                                            for (Pregunta pregunta1 : subs) {
                                                re.setPreguntaId(pregunta1);
                                                String respuesta1 = (String) request.getParameter("pregunta" + pregunta1.getId());
                                                re.setRespuesta(respuesta1);
                                                re.setRespuestaAbierta(null);
                                                resultadoevaluacionFacade.create(re);
                                            }
