 ...
 * @author acreditacion
 */
public class EditarActividadF2 implements Action {
    ...
    public String procesar(HttpServletRequest request) throws IOException, ServletException {
        ...
        Actividad a = (Actividad) sesion.getAttribute("actividad");
        ...
        try {
            ...
            Logger.getLogger(EditarActividadF2.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
