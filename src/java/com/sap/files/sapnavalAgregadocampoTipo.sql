...
-- Records of proceso
-- ----------------------------
INSERT INTO `proceso` VALUES ('1', 'En Configuración', '--', 'Proceso de Autoevaluación con fines de obtención de la acreditación institucional', '1', '1');
